...
export class TableComponent {
  tableData = [
    ...
    { day: 3, date: '2024-08-15', clockIn: '09:00', clockOut: '17:00', totalHours: 8, locationIn: 'Office', locationOut: '42 Abd Al Aziz Agamea, Sidi Gaber, Alexandria Governorate 5433112,Egypty' },
